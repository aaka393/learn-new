...
const getUserChannelProfile = asyncHandler(async (req, res) => {
    ...
    const channel = await User.aggregate([
        //match to find the channel by username
        {
            $match: {
                username: username?.toLowerCase()
            }
        },
        //lookup to get the channel's subscribers
        //this will be used to get the subscriber count
        {
            $lookup: {
                from: "subscriptions",
                localField: "_id",
        ...
        //lookup to get the channels subscribed to by the user
        //this will be used to check if the current user is subscribed to this channel
        {
            $lookup: {
                from: "subscriptions",
                localField: "_id",
        ...
        //how many subscribers and channels subscribed to
        {
            $addFields: {
                subscriberCount: {
                    $size: "$subscribers"
