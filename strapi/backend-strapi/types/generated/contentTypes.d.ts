...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    blocks: Schema.Attribute.DynamicZone<
      ['about.values', 'about.section', 'about.team-member']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    team: Schema.Attribute.Component<'about.team-member', true>;
...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    coverMedia: Schema.Attribute.Media<'images' | 'files' | 'videos'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiContactContact extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    description: Schema.Attribute.Blocks;
    email: Schema.Attribute.Email;
    form_enabled: Schema.Attribute.Boolean;
    form_fields: Schema.Attribute.Component<'shared.contact', true>;
    google_map_embed: Schema.Attribute.Blocks;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::contact.contact'
...
export interface ApiHomepageHomepage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    showcases: Schema.Attribute.Component<'shared.showcase', true>;
    slug: Schema.Attribute.UID;
    story: Schema.Attribute.Component<'shared.story', false>;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
